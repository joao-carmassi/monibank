...
btnEnviarFoto.addEventListener('click', () => {
    const resceberDadosExistente = JSON.parse(localStorage.getItem('cadastro'));

    resceberDadosExistente.imagem = imagemURL;

    localStorage.setItem('cadastro', JSON.stringify(resceberDadosExistente));
